<?php 
  ...
  if(isset($_POST["submit"]) && isset($_FILES["image"])){
    ...
    if(move_uploaded_file($tmp,"../user/img/".$file_name)){
        $insert  = "insert into doctor(Department,name,img) value('$Department','$name','$file_name')";
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Doctor Details</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Upload Doctor</h6>
                </div>
                <div class="card-body">
